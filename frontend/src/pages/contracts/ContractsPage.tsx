...
import { Plus, Download, Search, FileText, MoreVertical, Filter, TrendingUp, XCircle } from 'lucide-react';
        ...
        <div className="space-y-6 pb-24 md:pb-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-3">
                    <button className="flex items-center gap-2 px-4 py-2 border border-app-stroke rounded-lg text-app-text-main text-sm font-medium hover:bg-app-stroke/30 transition-colors">
                        <Download size={16} />
                        Relatório
                    </button>
                    <button
