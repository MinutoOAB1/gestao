...
export default function TermsPage() {
    ...
    const handleDownloadPDF = async () => {
        ...
        const splitText = doc.splitTextToSize(
            `1. Aceitação dos Termos\nAo acessar e usar a plataforma Advus, você concorda em cumprir e estar vinculado a estes Termos de Uso. Se você não concordar com qualquer parte destes termos, não deve usar nossos serviços.\n\n` +
            `2. Descrição do Serviço\nA Advus fornece uma plataforma de gestão para escritórios de advocacia, incluindo gestão de processos, clientes, documentos e automação de tarefas.\n\n` +
            ...
            `4. Propriedade Intelectual\nTodo o conteúdo, design e software da plataforma são de propriedade exclusiva da Advus ou de seus licenciadores.\n\n` +
            `5. Limitação de Responsabilidade\nA Advus não será responsável por quaisquer danos indiretos, incidentais ou consequentes resultantes do uso ou da incapacidade de usar a plataforma.\n\n` +
        ...
        doc.save('Termos_de_Uso_Advus.pdf');
    };
                    ...
                    <div className="prose prose-slate max-w-none space-y-8">
                        <section>
                            ...
                            <p className="text-slate-600 leading-relaxed">
                                Ao acessar e usar a plataforma Advus, você concorda em cumprir e estar vinculado a estes Termos de Uso. 
                                Estes termos regem o relacionamento entre você (usuário) e a Advus (prestadora do serviço). 
                        ...
                        <section>
                            ...
                            <p className="text-slate-600 leading-relaxed">
                                A Advus fornece uma plataforma de gestão baseada em nuvem para advogados e escritórios de advocacia. 
                        ...
                        <section>
                            ...
                            <p className="text-slate-600 leading-relaxed">
                                Todo o software, design, logotipos, textos e tecnologias utilizadas na Advus são protegidos por 
                        ...
                        <section>
                            ...
                            <p className="text-slate-600 leading-relaxed">
                                A Advus empenha-se em manter o sistema estável e seguro, porém não garante que a plataforma estará 
                        ...
                        <section className="pt-8 border-t border-slate-100">
                            <p className="text-slate-500 text-sm text-center">
                                ...
                                <a href="mailto:suporte@Advus.com.br" className="text-blue-600 font-medium ml-1">suporte@Advus.com.br</a>
                            </p>
                        </section>
                    </div>
                </motion.div>
