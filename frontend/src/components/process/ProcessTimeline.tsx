...
const UPDATE_TYPES = [
    { key: 'MOVIMENTO', label: 'Movimento', icon: FileText, color: 'text-gray-500' },
    { key: 'DECISAO', label: 'Decisão', icon: Gavel, color: 'text-amber-500' },
    { key: 'SENTENCA', label: 'Sentença', icon: Scale, color: 'text-red-500' },
    { key: 'DESPACHO', label: 'Despacho', icon: FileText, color: 'text-blue-500' },
    { key: 'AUDIENCIA', label: 'Audiência', icon: Calendar, color: 'text-purple-500' },
    { key: 'PRAZO', label: 'Prazo', icon: AlertTriangle, color: 'text-orange-500' },
    { key: 'OUTRO', label: 'Outro', icon: Clock, color: 'text-slate-500' },
];
                                            ...
                                            <div className={clsx(
                                                ...
                                                <div className="flex items-start justify-between gap-2 mb-2">
                                                    <span className={clsx(
                                                        ...
                                                        update.isImportant ? "bg-primary/20 text-primary" : "bg-app-stroke/50 text-app-text-muted"
                                                    )}>
                                                        {typeInfo.label}
                                                    </span>
                ...
                footer={
                    <>
                        ...
                        <button
                            ...
                            disabled={saving}
                            className="px-4 py-2 rounded-lg text-sm font-medium bg-primary text-white hover:bg-primary-dark transition-colors disabled:opacity-50"
                        >
